            ...
            {posts.slice(1, 4).map((post, index) => (
              ...
              >
                <Image
                  ...
                  width={250}
                  loading="lazy"
                  className="rounded-md cursor-pointer bg-yellow-400"
                />
                <div className="flex flex-col text-center sm:text-start items-center sm:items-start">
                <div className="mb-4 flex gap-2 ">
                  <CalendarDays className="w-5"/>
                  <span className="font-light">25/12/20244</span>
                </div>
                  ...
                  <Link href={`/blog/${post.id}`} className="flex items-center  gap-x-1 cursor-pointer">
                    <p className="mt-4 text-orange-500 hover:text-black text-xl ">Read More</p>
                    <MoveRight className="text-black mt-4"/>
                    </Link>
                </div>
                </motion.div>
